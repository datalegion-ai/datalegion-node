...
export class DataLegion {
  ...
  async _request<T>(
    ...
    this.lastRequestId = response.headers.get('Request-ID') ?? response.headers.get('request-id');
    ...
    this.lastCreditsUsed = creditsUsed !== null ? Number(creditsUsed) : null;
    this.lastCreditsRemaining = creditsRemaining !== null ? Number(creditsRemaining) : null;
